...
public class dz1 {
    ...
    /*
    Метод ишет максимальное значение 3 соседних элементов, последний и первый элемент считается соседним
    ...
    /*
    Метод принимает в качестве аргументов два целочисленных массива, и возвращает новый массив,
    ...
    /*
    Метод принимает в качестве аргументов строку, и сравнивает сумму первых х цифр с последними х цифрами
    где х количесво цифр. если сумма первых х цифр равна последним х цифрам возврашает строку с сообщением Повезло
    иначе Невезет
          Возможны следующие ошибки
           1) если в строке передаваемый в аргумент содержится любой другой символ кроме целого числа
